...
var uiController = (function() {
  ...
  return {
    ...
    tusviigDelgetsruu: function(tusuv) {
      document.querySelector(DOMstrings.tusuvValue).textContent = tusuv.tusuv;
      document.querySelector(DOMstrings.tusuvInc).textContent = tusuv.totalInc;
      document.querySelector(DOMstrings.tusuvExp).textContent = tusuv.totalExp;
      if (tusuv.huvi !== 0) {
